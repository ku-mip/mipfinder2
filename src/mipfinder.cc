...
std::filesystem::path
Mipfinder::phmmerAgainstSelf(const mipfinder::ProteinSet& cmips)
{
...
std::filesystem::path
Mipfinder::phmmerCmipsVsAncestors(const mipfinder::ProteinSet& cmips,
...
void
Mipfinder::writeHomologuesToFasta(const mipfinder::ProteinSet& homologous_cmips)
{
...
void Mipfinder::alignHomologousCmips(
    const std::filesystem::path& unaligned_seq_folder)
{
